const QUESTIONS = [
  ...
  },
  {
    ...
    answer: 1,
    explanation: "전문대학혁신지원사업단은 학생들의 역량 강화를 위한 다양한 프로그램과 대학 교육환경 개선을 지원하고 있습니다. 🔥"
  },
  {
...
"산악회", "산업체", "산타클로스", "산책로"
  ...
  },
  {
    ...
    answer: 3,
    explanation: "SKALA 울산캠퍼스, ASU 협약 및 초청 세미나, Higher VET 헝가리 국제협력방안 세미나 등은 대학의 산학·글로벌 협력을 확대하기 위한 주요 활동입니다. 📡"
  },
  {
    question: "울산과학대학교 전문대학혁신지원사업단이 AI·디지털 전환 사회를 움직이는 실행력 중심의 양성 목표로 삼고 있는 인재상은?",
    options: [
      "만두 빨리먹기 달인", "전문 직업인", "스피노사우르스", "로블록스 유튜버"
    ],
    answer: 1,
